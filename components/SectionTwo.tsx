...
import { Rocket, Star, Pencil, CheckCircle, Star as StarIcon, Paintbrush, DollarSign, Check, Brain, CheckCheck, Users, Flame, Ticket, PlayCircle, Clock, ChevronLeft, ChevronRight, Layers, Package } from 'lucide-react';
...
const ProgramCarousel = () => {
    ...
    return (
        <div
            className="relative w-full h-[500px] md:h-[800px] perspective-[1000px] flex items-center justify-center"
                ...
                {ASSETS.MODULE_IMAGES.map((img, i) => {
                    ...
                    return (
                        <div
                            ...
                            style={{
                                width: isActive ? (window.innerWidth < 768 ? '340px' : '500px') : (window.innerWidth < 768 ? '260px' : '350px'),
                                height: isActive ? (window.innerWidth < 768 ? '500px' : '700px') : (window.innerWidth < 768 ? '380px' : '500px'),
                                zIndex: 10 - Math.abs(distance),
                                opacity: Math.max(0, 1 - Math.abs(distance) * 0.3),
                                transform: `
                                    translateX(${distance * (window.innerWidth < 768 ? 260 : 480)}px) 
            ...
            <div className="absolute -bottom-12 flex gap-3">
                {ASSETS.MODULE_IMAGES.map((_, i) => (
                    <button
                        ...
                        className={`h-2 rounded-full transition-all duration-300 ${i === activeIndex ? 'w-8 bg-[#00CBD9]' : 'w-2 bg-white/20 hover:bg-white/40'
                            }`}
                    />
                ))}
            </div>
                    ...
                    <div className="relative z-10 max-w-[1600px] mx-auto flex flex-col items-center">
                        ...
                        <div className="w-full max-w-6xl mx-auto mt-32 mb-16">
                            <div className="text-center mb-12">
                                <h3 className="text-3xl md:text-5xl font-bold text-white mb-4 font-sans">
                                    <span className="bg-gradient-to-r from-[#00CBD9] to-[#AEECF1] bg-clip-text text-transparent">MAPA DOS MÓDULOS</span>
                                </h3>
                                <p className="text-gray-400 text-lg">Visualize rapidamente todos os módulos e conteúdos da formação</p>
                            </div>

                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
                                {ASSETS.MODULE_LIST.map((moduleName, index) => (
                                    <div key={index} className="group relative overflow-hidden rounded-2xl bg-gradient-to-r from-[#05121d] to-[#020610] border border-[#00CBD9]/20 hover:border-[#00CBD9]/60 transition-all duration-300 p-1">
                                        <div className="relative flex items-center justify-between p-4 md:p-6 h-full">
                                            <span className="text-white font-medium text-sm md:text-base pr-4 font-sans">{moduleName}</span>

                                            <div className="relative w-10 h-10 md:w-12 md:h-12 flex items-center justify-center rounded-full bg-gradient-to-br from-[#00CBD9] to-[#008C99] shadow-[0_0_15px_rgba(0,203,217,0.4)] group-hover:scale-110 transition-transform duration-300 shrink-0">
                        ...
                        <div className="flex flex-wrap justify-center gap-4 md:gap-6 mt-20 md:mt-24">
                            <div className="flex items-center gap-3 px-6 py-4 rounded-xl bg-[#05121d]/80 border border-[#00CBD9]/30 backdrop-blur-sm shadow-[0_0_15px_rgba(0,203,217,0.1)] hover:border-[#00CBD9]/60 transition-colors duration-300">
                                <Layers className="w-6 h-6 text-[#00CBD9]" />
                                <span className="text-gray-200 font-medium text-lg">10 Módulos</span>
                            </div>
                            <div className="flex items-center gap-3 px-6 py-4 rounded-xl bg-[#05121d]/80 border border-[#00CBD9]/30 backdrop-blur-sm shadow-[0_0_15px_rgba(0,203,217,0.1)] hover:border-[#00CBD9]/60 transition-colors duration-300">
                                <PlayCircle className="w-6 h-6 text-[#00CBD9]" />
                                <span className="text-gray-200 font-medium text-lg">+ 100 horas aula</span>
                            </div>
                            <div className="flex items-center gap-3 px-6 py-4 rounded-xl bg-[#05121d]/80 border border-[#00CBD9]/30 backdrop-blur-sm shadow-[0_0_15px_rgba(0,203,217,0.1)] hover:border-[#00CBD9]/60 transition-colors duration-300">
                                <Package className="w-6 h-6 text-[#00CBD9]" />
                                <span className="text-gray-200 font-medium text-lg">10 cursos em 1</span>
                            </div>
                        </div>
